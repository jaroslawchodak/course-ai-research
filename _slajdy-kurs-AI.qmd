...
- B9 · Deep research + weryfikacja źródeł
- B10 · 🆕 Lokalne LLM + karta `privacy cage`
- B11 · 🆕 Agent nad plikami + Clustering Demo (live)
...
**10:45–12:15 · 40% / 60% · blok prowadzony „decyzja + demonstracja"**
...
## B10 · 📚 Uruchamianie modeli lokalnych z agentami — *dla chętnych* {.smaller}
...
## B10 · 📚 Agentic vs Chatbot — rozróżnienie warte zapamiętania {.smaller}
...
**13:15–14:45 · 45% / 55% · blok prowadzony „zrozum i nadzoruj"**
...
**Test ręczny w czacie:** wklej `INSTRUKCJE-PROJEKTU.md` + jeden plik ze `zrodla/`, wydaj dwuetapowe polecenie **z akceptacją po każdym kroku**, zapisz log do `notatki/`.
