...
>
> **🎤 Mikroćwiczenie (10–15 min):** weź szablon (`kurs-pe/szablony/skill-*.md`) → przepisz **opis-wyzwalacz** i **2 kroki** pod swoją dyscyplinę → przetestuj w czacie („Działaj dokładnie według tej procedury").
