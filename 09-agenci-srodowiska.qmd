...
Weź szablon (`kurs-pe/szablony/skill-*.md`), przepisz **opis-wyzwalacz** i **dwa pierwsze kroki** pod własną dyscyplinę, a potem przetestuj w czacie poleceniem „Działaj dokładnie według tej procedury". Artefakt: własny `SKILL.md` sprawdzony na jednym przebiegu.
:::
