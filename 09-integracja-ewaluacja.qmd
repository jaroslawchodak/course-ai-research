...
Cały kurs to jeden ciąg: **prompt (Dzień 1) → kontekst i dane (Dzień 2) → nadzorowany agent (Dzień 3)**. Osobisty protokół pracy z AI łączy cztery elementy w jedną stronę:
