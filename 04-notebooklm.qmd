...
Najlepiej pokazać NotebookLM na konkretnym, sprawdzonym schemacie czytania książki. Zaczynamy od **preambuły sesji**, którą wklejamy raz — to grounding w czystej postaci, te same zasady co w Dniu 1, tylko zaaplikowane do całej książki:
...
Ceną wygody jest chmura: materiały trafiają na serwery Google. Niezanonimizowanych transkrypcji, recenzji pod NDA czy danych pacjentów tam **nie wgrywamy**. To naturalne wejście w Dzień 3, gdzie pokazujemy, jak te same zadania zrobić lokalnie, gdy dane są wrażliwe.
:::

NotebookLM domyka temat kontekstu od strony narzędzia gotowego. Teraz przechodzimy do dnia trzeciego — najpierw do trybów *deep research*, a potem do tego, co zrobić, gdy dane nie mogą opuścić komputera.
