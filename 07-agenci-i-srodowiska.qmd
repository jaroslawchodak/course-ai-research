...
**Agent** to model wyposażony w **narzędzia** (czytanie i zapis plików, wyszukiwanie) oraz w **plik instrukcji projektowych** — trwały „prompt systemowy projektu". Ten plik jest bezpośrednim rozwinięciem czterowarstwowego promptu z Dnia 1 i briefu z Dnia 2, tyle że trwałym.
...
malejący rozmiar, czytelne etykiety. Styl flat, granat/bursztyn, 16:9." -->
...
Do tego dochodzi klasyka z Dnia 1: edytory Markdown (iA Writer, Typora, MarkEdit, VS Code, Obsidian). Nie narzucamy jednego — chodzi o dobranie narzędzia do własnego stylu.
